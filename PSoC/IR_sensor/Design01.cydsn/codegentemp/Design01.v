...
module top ;
	...
	wire [0:0] tmpOE__ir_out_net;
	wire [0:0] tmpIO_0__ir_out_net;
	wire [0:0] tmpINTERRUPT_0__ir_out_net;
	electrical [0:0] tmpSIOVREF__ir_out_net;
	...
	cy_psoc3_pins_v1_10
		...
		ir_out
		 (.oe(tmpOE__ir_out_net),
		  .y({1'b0}),
		  .fb({Net_3}),
		  .io({tmpIO_0__ir_out_net[0:0]}),
		  .siovref(tmpSIOVREF__ir_out_net),
		  .interrupt({tmpINTERRUPT_0__ir_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ir_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Debouncer_v1_0 ir_debouncer (
        ...
        .pos(Net_13),
        .q(Net_5));
    defparam ir_debouncer.EitherEdgeDetect = 0;
    defparam ir_debouncer.NegEdgeDetect = 1;
    defparam ir_debouncer.PosEdgeDetect = 1;
    defparam ir_debouncer.SignalWidth = 1;
