...
*/
     ...
     *  @{
     */
        #define echo_1_INTR_NONE      (uint16)(0x0000u)
        #define echo_1_INTR_RISING    (uint16)(0x0001u)
        #define echo_1_INTR_FALLING   (uint16)(0x0002u)
        #define echo_1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define echo_1_INTR_MASK      (0x01u) 
#endif /* (echo_1__INTSTAT) */
...
/* SIO registers */
#if defined(echo_1__SIO_CFG)
    #define echo_1_SIO_HYST_EN        (* (reg8 *) echo_1__SIO_HYST_EN)
    #define echo_1_SIO_REG_HIFREQ     (* (reg8 *) echo_1__SIO_REG_HIFREQ)
    #define echo_1_SIO_CFG            (* (reg8 *) echo_1__SIO_CFG)
    #define echo_1_SIO_DIFF           (* (reg8 *) echo_1__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define echo_1_0_INTTYPE_REG 		(* (reg8 *) echo_1__0__INTTYPE)
#endif /* (echo_1__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_echo_1_H */
