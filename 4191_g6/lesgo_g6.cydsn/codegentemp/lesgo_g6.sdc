...
# Date: Sat, 19 Aug 2023 16:30:46 GMT
#set_units -time ns
...
create_generated_clock -name {ir_debouncer_clk} -source [get_pins {ClockBlock/clk_sync}] -edges {1 240001 480001} [list [get_pins {ClockBlock/dclk_glb_4}]]
